...
setup(
  ...
  entry_points = { 'desktop.sdk.application': 'metadata_enricher=metadata_enricher' },
  zip_safe = False,
  package_data = {
    # Include static resources.  Package_data doesn't
    # deal well with directory globs, so we enumerate
    # the files manually.
    'metadata_enricher': expand_package_data(
      ["src/metadata_enricher/templates", "src/metadata_enricher/static"],
